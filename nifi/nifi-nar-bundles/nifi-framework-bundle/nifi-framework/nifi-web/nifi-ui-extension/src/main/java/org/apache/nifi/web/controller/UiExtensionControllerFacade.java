...
public interface UiExtensionControllerFacade {
     ...
     * @throws ResourceNotFoundException if the specified component does not exit
     ...
     * in a cluster.
     */
    ComponentConfiguration setAnnotationData(UiExtensionControllerRequest configurationRequest, String annotationData)
     ...
     */
    ComponentConfiguration getComponentDetails(UiExtensionControllerRequest configurationRequest)
